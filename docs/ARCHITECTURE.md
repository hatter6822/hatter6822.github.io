...
- Removed deprecated post-chart insight badges and textual flow-summary copy from the flow container so map analysis stays centered on graph topology and interior declaration panels.
