...
- A breadcrumb navigation bar at the top of the declaration flowchart provides a module-name return button for free bidirectional traversal between module and declaration contexts.
