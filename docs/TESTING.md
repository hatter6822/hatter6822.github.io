...
- declaration search via dot-append notation (`declarationSearchMatch` exact/prefix/substring matching, module-qualified declaration resolution, cross-module search, edge cases for missing dots and module-only queries)
