...
- Confirm that when a declaration has more than 12 calls or callers, same-module declarations are prioritized in the visible first 10, with a "+N more" summary node for the remainder.
