...
- Color-codes interior declaration kinds in both selector options (key) and rendered declaration chips for faster kind scanning
- Sorts interior declaration lists case-insensitively by symbol name, including aggregated `All` selections
