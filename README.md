...
- Supports dot-append declaration search (e.g., `SeLe4n.Kernel.API.apiInvariantBundle`) directly from the module-search bar; progressively resolves module prefixes and matches declaration suffixes with exact, prefix, and substring ranking; partial matches appear as styled suggestions selectable via keyboard or mouse
